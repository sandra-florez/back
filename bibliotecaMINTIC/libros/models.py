...
class cat_libros(models.Model):
    ...
    # cod_autor = models.ForeignKey(cat_autores, related_name="cod_autor", on_delete=models.DO_NOTHING)
    # cod_editorial = models.ForeignKey(cat_editoriales, related_name="cod_editorial", on_delete=models.DO_NOTHING)
...
class cat_libros_plu(models.Model):
    # cod_libro = models.ForeignKey(cat_libros, related_name="cod_libro", on_delete=models.DO_NOTHING)
